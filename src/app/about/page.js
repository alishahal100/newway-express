    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-blue-50 via-white to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            About <span className="text-blue-600">Newway Express</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Leading the future of logistics with innovation, reliability, and global reach
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/img4.jpg"
                  alt="Newway Express Company History"
                  fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ 
              { title: 'Excellence', description: 'We strive for perfection in every shipment, every time.' },
              { title: 'Innovation', description: 'Constantly evolving our technology and processes to stay ahead.' },
              { title: 'Reliability', description: 'Building trust through consistent, dependable service.' },
              { title: 'Sustainability', description: 'Committed to reducing our environmental impact.' },
              { title: 'Customer Focus', description: 'Your success is our priority in every decision.' },
              { title: 'Integrity', description: 'Operating with honesty and transparency in all dealings.' }
            ].map((value, index) => (
              <motion.div
                key={value.title}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center">
