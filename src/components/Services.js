      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Trusted as the best logistics company in the world by businesses across industries.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              <motion.div
                ...
                className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-500 rounded-xl flex items-center justify-center text-white mb-6"
              >
                {service.icon}
              </motion.div>
